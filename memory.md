...
- **Branch ativa (15/09/2026)**: `chore/gate-autonomo-15-09` (trabalho autônomo do gate, commit 15/09 → merge em `main`; `main` em `1737ab3`). CI permanece desabilitado.
...
> Backlog histórico: [docs/archive/PLANO.md](docs/archive/PLANO.md). Branch ativa: **`chore/gate-autonomo-15-09`** (base `main` `1737ab3`). CI **não** reabilitar sem pedido.
