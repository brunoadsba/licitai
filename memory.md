...
- **Branch ativa (15/09/2026)**: `main` (`9bb3ed8`; gate autônomo mergeado). CI permanece desabilitado.
...
> Backlog histórico: [docs/archive/PLANO.md](docs/archive/PLANO.md). Branch ativa: **`main`** (`9bb3ed8`). CI **não** reabilitar sem pedido.
